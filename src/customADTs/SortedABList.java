/* ----------------------------------------------
 * "SortedABList.java"
 * CS401 Fall 2018, Refer to Textbook "Object-Oriented Data Structures Using Java" - Chapter 6
 * 
 * Sorted-Array-Based List
 * 
 * Elements supplied to this class MUST implement a compareTo method, otherwise they cannot be sorted.
 * 
 * Two constructors:
 *  Default Constructor -  SortedABList<T>() use the natural order of the elements as defined by their compareTo method 
 *  Other one - SortedABList<T>(Comparator<T> comp) sort the added elements using the supplied comparator.
 */ 
package customADTs;
                             ...
                             
{
  ...
  protected void recFind(T target, int first, int last)	// recursive find, binary search
  // Used by find.
  {
    int result;
    if (first > last)
